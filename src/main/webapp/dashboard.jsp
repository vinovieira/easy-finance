...
<div class="container">
  <div class="mt-5 ms-md-5 me-md-5">
    <div class="card mb-3">
      ...
      <div class="card-body table-responsive row mb-3 justify-content-start align-items-center">
        <div class="col-sm-4 mb-3">
          <h5 class="card-title">Gestão de Finanças</h5>
          <p class="card-text">Mantenha suas finanças sob controle!</p>
        </div>
        <div class="card mb-3 col-sm-auto">
          <div class="card-body">
        ...
        <div class="row">
            ...
            <div class="mb-3">
              <div class="card border-success">
                <div class="card-body ">
                  ...
                  <h2 class="card-text">
                    <fmt:formatNumber value="${incomeSum}" type="currency" groupingUsed="true" maxFractionDigits="2" minFractionDigits="2" currencyCode="BRL" />
                  </h2>
            ...
            <div class="mb-3">
              <div class="card border-danger">
                <div class="card-body ">
                  ...
                  <h2 class="card-text">
                    <fmt:formatNumber value="${expenseSum}" type="currency" groupingUsed="true" maxFractionDigits="2" minFractionDigits="2" currencyCode="BRL" />
                  </h2>
            ...
            <div class="mb-3">
              <div class="card border-primary">
                <div class="card-body">
                  ...
                  <h2 class="card-text"><fmt:formatNumber value="${incomeSum - expenseSum}" type="currency" groupingUsed="true" maxFractionDigits="2" minFractionDigits="2" currencyCode="BRL" /></h2>
                </div>
              </div>
            </div>
          </div>
          <div class="col-sm-8">
            <table class="table">
              <thead>
              <tr>
                <th class="text-center" colspan="4">Atividades Recentes</th>
              </tr>
              </thead>
              <tbody>
              <c:forEach items="${dashboardList}" var="operation">
                <tr>
                  ...
                  <td class="text-end ${operation.getClass() == 'class br.com.easyfinance.easyfinance.model.Expense' ? "text-danger-emphasis" : "text-success-emphasis"}"> <fmt:formatNumber value="${operation.value}" type="currency" groupingUsed="true" maxFractionDigits="2" minFractionDigits="2" currencyCode="BRL" /></td>
                  <td class="text-end">
                    <fmt:parseDate
